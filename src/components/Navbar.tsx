...
const Navbar = () => {
  return (
    <nav className="flex justify-between items-center my-3 mx-5 shadow-2xl p-2">
      <Link
      ...
      <div className="flex text-xl p-3 rounded-sm gap-4">
        <p>
          <NavLink
            to="/"
            className={({ isActive }) => `p-2 rounded-md ${
        ...
        <p>
          <NavLink
            to="/products"
            className={({ isActive }) =>
              `p-3 rounded-md ${isActive ? "bg-pink-100 font-bold" : ""}`
            }
          >
            Products Page
          </NavLink>
